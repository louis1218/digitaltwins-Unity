...
{
    Unity.Robotics.UrdfImporter.Control.MotionPlanning controller;
    ...
    {
        direction = 0;
        controller = (Unity.Robotics.UrdfImporter.Control.MotionPlanning)this.GetComponentInParent(typeof(Unity.Robotics.UrdfImporter.Control.MotionPlanning));
